  ...
  return (
    ...
    <div className="footer1">
        <div className="-mx-4 flex flex-wrap justify-center align-middle">
                ...
                <div className="logo px-4 sm:w-1/2 lg:w-2/12 text-center" >
            ...
            <div className="w-full px-4 sm:w-1/2 text-center content-center lg:w-3/12">
                <div className="mb-3 w-full mx-auto">
                    <h4 className="text-dark mb-4 text-lg text-center font-bold">Location</h4>
                </div>
            </div>
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12 text-center">
                <h4 className="text-dark mb-3 text-lg font-bold">Contact Us</h4>
