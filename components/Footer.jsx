...
const Footer = () => {
  return (
        <footer className="relative z-10 bg-[var(--black)] text-[var(--white)] pt-20 pb-10  lg:pb-20" id="CONTACT">
            ...
            <div className="-mx-4 flex flex-wrap justify-center align-middle">
                <div className="w-full  sm:w-2/3 lg:w-3/12">
                    <div className="mb-10 w-full text-center">
                        <a href="/" className="mb-6 inline-block max-w-[160px]">
                            <img src="../images/Logo.png" alt="SRDTU_logo" className="max-w-full" />
                        </a>
                        <p className="text-body-color mb-7 text-base font-bold">
                            The Robotics Society, <br/>Delhi Technological University
                        </p>
                ...
                <div className="w-full px-4 sm:w-1/2 lg:w-2/12 text-center">
                    <div className="mb-10 w-full">
                        <h4 className="text-dark mb-3 text-lg font-bold">Quick Links</h4>
                        <ul>
                            <li>
                                <a href="#ABOUT"
                ...
                <div className="w-full px-4 sm:w-1/2 text-center content-center lg:w-3/12">
                    <div className="mb-3 w-full mx-auto">
                        <h4 className="text-dark mb-4 text-lg text-center font-bold">Follow Us On</h4>
                        <div className="mb-6 flex items-center content-center justify-center">
                            <a href="javascript:void(0)"
                                className="text-dark hover:bg-primary hover:border-primary mr-4 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                                <svg width="8" height="16" viewBox="0 0 8 16" className="facebook fill-current">
                                    <path
                            ...
                            <a href="javascript:void(0)"
                                className="text-dark hover:bg-primary youtube hover:border-primary mr-4 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                            ...
                            <a href="https://in.linkedin.com/company/srdtu"
                                className="text-dark hover:bg-primary linkedin hover:border-primary mr-4 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                        ...
                        <p className="text-body-color text-base">&copy; 2023 SR-DTU</p>
                    </div>
                </div>
                <div className="w-full px-4 sm:w-1/2 lg:w-1/4 mt--2 flex items-center justify-center content-center">
