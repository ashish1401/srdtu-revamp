...
const Footer = () => {
    return (
        <footer class="relative z-10 bg-gradient-to-l from-black to-blue-500 font-sora text-white pt-20 pb-10  lg:pb-20" id="CONTACT">
                ...
                <div class="-mx-4 flex flex-wrap justify-center align-middle">
                    ...
                    <div class="w-full px-4 sm:w-1/2 text-center content-center lg:w-3/12">
                        <div class="mb-3 w-full mx-auto">
                            ...
                            <div class="mb-6 flex items-center content-center justify-center">
                                <a href="javascript:void(0)"
                                    class="text-dark hover:bg-primary hover:border-primary mr-4 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                                    <svg width="8" height="16" viewBox="0 0 8 16" class="facebook fill-current">
                                        <path
                                ...
                                <a href="javascript:void(0)"
                                    class="text-dark hover:bg-primary youtube hover:border-primary mr-4 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                                ...
                                <a href="https://in.linkedin.com/company/srdtu"
                                    class="text-dark hover:bg-primary linkedin hover:border-primary mr-4 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                            ...
                            <p class="text-body-color text-base">&copy; 2023 SR-DTU</p>
                        </div>
                    </div>
