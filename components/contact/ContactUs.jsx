...
const ContactUs = () => {
  ...
  return (
    <div
      className='md:bg-center p-10 md:mt-20 grid grid-cols-2 flex-row gap-10 justify-center'
      style={{ backgroundImage: "url('/bg/ContactUs.png')", backgroundSize: '100% 100%', gridTemplateColumns: '1.5fr 1fr' }}
    >
      <motion.div
        className='flex-[0.75] w-[110%] md:w-full bg-[#1c1734] p-8 rounded-2xl'
      >
        ...
        <form
          ...
          className='mt-12 flex flex-col gap-8 text'
        >
          <label className='flex flex-col'>
            <span className='text-white text-[16px] md:text-[24px] font-bold mb-4'>Your Name</span>
          ...
          <label className='flex flex-col'>
            <span className='text-white text-[16px] md:text-[24px] font-bold mb-4'>Email</span>
          ...
          <label className='flex flex-col'>
            <span className='text-white text-[16px] md:text-[24px] font-bold mb-4'>Your Query</span>
