                                    ...
                                    {SeniorcouncilMembers.map((member, index) => (
                                        <div class="relative w-[300px] rounded-xl shadow bg-gray-800 border-gray-700">
                                            ...
                                            <div class="p-5">
                                                ...
                                                <div className='my-auto flex flex-row justify-between pb-4'>
                                                    <h5 class="text-xl font-bold tracking-tight my-auto text-slate-300 ">{member.position}</h5>
                                                ...
                                                <p class="hidden mb-3 font-normal  text-gray-400">{member.info}</p>
