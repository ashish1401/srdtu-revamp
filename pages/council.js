...
const Council = () => {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-cover bg-top md:pt-10 font-sora flex flex-col justify-center items-center"
                            ...
                            <div className={styles.container}>
                                ...
                                <div className={`grid grid-cols-1  bg-opacity-5  md:grid-cols-2 lg:grid-cols-3 gap-20 pl-[10px] pr-[10px] justify-between`}>
                                    {SeniorcouncilMembers.map((member, index) => (
                                        <div className={`${styles.cardContainer} shadow-lg border-secondary shadow-secondary rounded-xl  bg-gray-800`}>
                                            <div className='relative ' >
                                                <img
                                                    src={`images/Council/SeniorCouncilMember${index + 1}.jpg`}
                                                    alt="Profile"
                                                    className={`shadow-md shadow-primary w-[300px] h-[280px] rounded-t-xl`}
                                                />
                                                <div class="p-5">
